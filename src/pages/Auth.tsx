    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Your journey to knowledge starts here</p>
        </div>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) => setSignUpData({ ...signUpData, role: value as 'creator' | 'consumer' })}
                    >
                      <div className="flex items-center space-x-2 border rounded-lg p-3 cursor-pointer hover:bg-accent/50 transition-colors">
                        ...
                        <Label htmlFor="consumer" className="flex items-center gap-2 cursor-pointer flex-1">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">Access learning pathways</div>
                          </div>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 border rounded-lg p-3 cursor-pointer hover:bg-accent/50 transition-colors">
                        ...
                        <Label htmlFor="creator" className="flex items-center gap-2 cursor-pointer flex-1">
                          ...
                          <div>
                            <div className="font-medium">Create & Teach</div>
                            <div className="text-sm text-muted-foreground">Build learning pathways</div>
                          </div>
                        </Label>
                      </div>
                    </RadioGroup>
